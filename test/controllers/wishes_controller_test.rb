...
class WishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wish" do
    assert_difference("Wish.count") do
      post wishes_url, params: { wish: { activity_id: @wish.activity_id, description: @wish.description, estimation: @wish.estimation, name: @wish.name, priority: @wish.priority } }
    end
  ...
  test "should update wish" do
    patch wish_url(@wish), params: { wish: { activity_id: @wish.activity_id, description: @wish.description, estimation: @wish.estimation, name: @wish.name, priority: @wish.priority } }
